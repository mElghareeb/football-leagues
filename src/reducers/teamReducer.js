...
const initTeam = {
    ...
    "squad": [{
        ...
        },
        {
            ...
            "name": "Moritz Nicolas",
            "position": "Goalkeeper",
            "dateOfBirth": "1997-10-21T00:00:00Z",
            "countryOfBirth": "Germany",
            "nationality": "Germany",
            "role": "PLAYER"
        },
        ...
        },
        {
            ...
            "name": "Mandela Egbo",
            "position": "Defender",
            "dateOfBirth": "1997-08-17T00:00:00Z",
...
export function TeamReducer(state = initTeam, action) {
    switch (action.type) {
        case 'SET_TEAM_DATA':
            return {
                ...state,
                ...
                // tla: action.payload.tla,
                // crestUrl: action.payload.crestUrl,
                // address: action.payload.address,
                // phone: action.payload.phone,
                // website: action.payload.website,
                // email: action.payload.email,
                // founded: action.payload.founded,
                // clubColors: action.payload.clubColors,
                // venue: action.payload.venue,

            };

        case 'GET_TEAM_IS_LOADING':
            return {
                ...state,
